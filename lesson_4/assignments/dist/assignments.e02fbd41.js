 ...
 */ function updateProgress(event) {
    ...
    } else // Sometimes length is unknown
...
(0, _axiosDefault.default).interceptors.response.use((response)=>{
    ...
    console.log("Response recieved in:", duration, "ms");
...
function buildCarousel(images) {
    _carouselJsx.clear();
    images.forEach((img)=>{
        const item = _carouselJsx.createCarouselItem(img.url, "Cat Image", img.id);
        _carouselJsx.appendCarousel(item);
    });
    _carouselJsx.start();
}
//Initial load
...
async function favourite(imgId) {
    try {
        ...
        if (existing) {
            await (0, _axiosDefault.default).delete(`/favourites/${existing.id}`);
...
},{"./Carousel.jsx":"i4NpX","axios":"kooH4","@parcel/transformer-js/src/esmodule-helpers.js":"jnFvT"}],"i4NpX":[function(require,module,exports,__globalThis) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
